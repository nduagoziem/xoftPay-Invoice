    ...
    <div class="container-fluid d-flex align-items-center mb-3" :style="{background: 'aliceblue', height: '90px'}">
        ...
        <div class="container d-flex justify-content-around">
            ...
            <form :style="{background: 'whitesmoke'}">
                ...
                <input @input="searchItems" type="text" placeholder="Search Items..." 
            ...
            <button class="smallScreenBtn px-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Search Items</button>
            ...
            <RouterLink to="/items/add"><button class="py-2 px-3">New Item</button></RouterLink>
