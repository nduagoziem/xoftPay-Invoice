...
<template>
    <div class="container-fluid d-flex align-items-center mb-3" :style="{background: 'aliceblue', height: '90px'}">
        ...
        <div class="container d-flex justify-content-around">
            ...
            <button class="smallScreenBtn px-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Search Invoice</button>
            ...
            <RouterLink to="/invoices/add"><button class="py-2 px-3">New Invoice</button></RouterLink>
